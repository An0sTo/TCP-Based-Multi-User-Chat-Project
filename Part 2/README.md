...
4. User Login & Username Rules
   Upon launching the client, a login window will appear. Please note the following       rules:
 
     * Uniqueness: Every user must have a unique name.

     * Case Sensitivity: The system treats names as unique regardless of                      capitalization. For example, if "Avi" is already logged in, you cannot log in as     "avi" or "AVI." The system will reject the name and display an error.
      * Identification: Your active username will be displayed in the top-left corner of the chat window for easy reference.


5. Messaging and Communication:

   Once connected, you can start chatting:
   * Direct Messaging: Click a name in the Online Users column to select them.
 
   * Manual Format: Type the recipient's name followed by a colon and a space in the        message box: RecipientName: {your message}
6. Disconnecting.
